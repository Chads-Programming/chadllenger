...
export default [
  ...
  layout('./challenger/layout.tsx', [
    ...
    route(`challenge/${ChallengeType.Clash}/:codename`, './challenger/challenge/clash/clash.page.tsx'),
    route(`challenge/${ChallengeType.Quiz}/:codename`, './challenger/challenge/quiz/quiz.page.tsx'),
